    ...
    return (
        <div className='uppercase h-[120vh] w-screen md:w-auto pb-10'>
            ...
            {count && <div className='relative h-1/4 md:h-[20%] flex flex-col md:flex-row justify-between items-center px-12 mt-10 md:m-0 md:border-b'>
                ...
                <div className="relative"><Link href={count[0].url} className='px-10 py-4 text-sm bg-black border text-white border-black hover:bg-white hover:text-black mt-4'>Sale</Link>
                <EditCounter item={count[0]} api={`${NEXT_PUBLIC_HOST_URL}/api/landingPage/counter`}/>
                </div>
            </div>}
