      ...
      <div className='p-8 border-y flex flex-col justify-center gap-6 items-center'>
        <div className='md:hidden border-b pb-10'>
          <ul className='flex justify-center gap-2 text-left'>
            ...
            <li className='group'><Link href='/featured/allproducts/New Arrival' className='text-sm whitespace-nowrap px-2 py-10 border-x group-hover:underline underline-offset-2'>New Arrivals</Link></li>
      ...
      <div className='flex'>
        <div className='hidden md:flex justify-center md:w-2/12'>
          <ul className='flex flex-col justify-center gap-4 text-left h-96 sticky top-8 border-r px-16'>
            ...
            <li className='group'><Link href='/featured/New Arrival' className='group-hover:underline underline-offset-2'>New Arrivals</Link></li>
