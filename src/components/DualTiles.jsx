      ...
      {data.length > 0 ? (
        <div className='md:px-24 uppercase flex flex-col'>
          {data.map((item, index) => (
            <div
              key={index}
              className='h-[calc(100vh-6rem)] flex flex-col md:flex-row justify-evenly md:justify-between md:items-center px-8 md:p-0'>
              {index % 2 === 0 ? (
                <>
                  ...
                  <div className='flex justify-center md:w-1/2 h-1/2 md:h-full items-center'>
                    <img src={item.image} alt={item.title} className='md:ml-10 h-full md:h-5/6 w-full md:w-8/12' />
                  </div>
                </>
              ) : (
                <>
                  <div className='flex justify-center md:w-1/2 h-1/2 md:h-full items-center'>
                    <img src={item.image} alt={item.title} className='md:mr-10 h-full md:h-5/6 w-full md:w-8/12' />
                  </div>
