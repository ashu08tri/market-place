...
const SubscribeModal = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded shadow-lg w-[29%] h-[90%] overflow-y-scroll">
        <div className="relative h-80 w-full"> {/* Adjust height as needed */}
          <Image
            ...
            className="rounded-t-lg" // Optional: Adds a rounded top to match the modal's style
          />
        </div>
        <div className="p-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Sign up and get early access</h2>
          <p className='text-lg '>Sign up to receive early access to our deals. Our selection of products is vast and offers something for everyone. Shop now and save.</p>
