...
import { Allcollection } from '@/utils/Modal/collectionSchema'; // Adjust path as per your schema location
...
export async function GET(request, { params }) {
  try {
    ...
    const alltype = await Allcollection.find()
    .populate('itemfirst')
    .populate('itemsecond')
    .populate('itemthird')
    .populate('itemfourth')
    ...
    alltype.forEach(product => {
      combinedProducts.push(...product.itemfirst, ...product.itemsecond, ...product.itemthird, ...product.itemfourth);
    });
