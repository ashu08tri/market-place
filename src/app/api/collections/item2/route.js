...
import { CollectionTwo, Allcollection } from '@/utils/Modal/collectionSchema';
...
export async function GET(){
    try{
        const item = await CollectionTwo.find();
    ...
    const data =  
      {
        ...
        amount: 400,
        img: ['https://sahara-theme.myshopify.com/cdn/shop/products/FAEStudio-726.jpg']
      };
  
    try {
      const newItem = new CollectionTwo(data);
      await newItem.save();
